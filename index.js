...
const zooAnimals = [
  ...
  */
  ...
  console.log('topic2-request1', animalNames(zooAnimals))
  /* 🦁🦁🦁 Request 2: .map() 🦁🦁🦁
  ...
  */
  ...
  //   const lowerC = data.map(function(item){
  ...
  function lowerCaseNames(data){
    const lowerC = data.map((item) => { return item.animal_name.toLowerCase();})
    return lowerC;
  }
  ...
  */
  ...
  function USApop(data){
    const totalPop = data.reduce((accumulator, item) => { 
...
function greeting(a, b){
 ...
 console.log('callbacks', consume('matt', 'stack', greeting)) 
...
console.log('topic3', cuboid)
console.log('topic3', cuboid.volume())
console.log('topic3', cuboid.surfaceArea())
...
class CubeMaker2 extends CuboidMaker {
  constructor(cubeAttributes) {
    super (cubeAttributes);
    this.sidelength = cubeAttributes.sidelength
    // could use length, width, and height, but it would be redundent on a cube 
  }
  volume() {
